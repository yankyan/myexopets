...
class ProblemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post problems_url, params: { problem: { date: @problem.date, desk: @problem.desk, pet_id: @problem.pet_id } }
    end
  ...
  test "should update problem" do
    patch problem_url(@problem), params: { problem: { date: @problem.date, desk: @problem.desk, pet_id: @problem.pet_id } }
